      ...
      <div className="relative grid auto-rows-[auto auto] grid-flow-row w-full h-full  pt-12">
        <div className="relative row-start-1 w-full h-full">
          <div className="relative grid auto-cols-[auto auto] grid-flow-col h-full w-full">
            <div className="col-start-1 h-full w-full relative pl-6">
              <div className="relative flex border-2 w-full h-full pb-2">
                <Image layout="fill" src="/images/footerstatic.png" />
                <div className="relative w-full h-full grid grid-flow-row auto-rows-[auto auto]">
                  <div
                    id="digi"
                    className="relative w-full text-center h-fit text-offWhite font-mag text-[8.5vw] row-start-1"
                  >
                    DIGITALAX
                  </div>
                  <div
                    id="code"
                    className="font-fut text-[1vw] relative row-start-2 place-self-center pb-2"
                  >
                    100 105 103 105 116 97 108 97 120
                  </div>
                  <div className="relative w-full pl-8 pr-8 h-10 grid grid-flow-row auto-rows-[auto auto] row-start-3">
            ...
            <div className="md:col-start-2 relative h-fit w-full md:w-96 text-xs text-midWhite place-self-end font-lib text-right w-fit leading-8 col-start-1 row-start-2 md:row-start-1 pr-10 pl-6">
        ...
        <div className="relative row-start-2 w-full h-full pt-16">
          <div className="grid grid-flow-row auto-rows-[auto auto] relative w-full h-fit gap-2">
            <div id="foot1" className="relative row-start-1 w-full h-1">
              
            </div>
            <div id="foot2" className="relative row-start-2 w-full h-1">
            </div>
            <div id="foot3" className="relative row-start-3 w-full h-1">
          ...
          <div className="relative grid auto-cols-[auto auto] grid-flow-col h-full w-full">
            <div className="col-start-1 h-full w-full relative pt-6">
              <div className="relative w-fit h-fit grid grid-flow-row auto-rows-[auto auto]">
                <div className="relative w-fit h-fit row-start-1 pl-6 pb-1">
                  END OF LINE
                </div>
            ...
            <div className="col-start-2 h-full w-fit relative place-self-center pt-6 cursor-sewingHS">
              <div
            ...
            <div className="col-start-3 h-full w-fit relative place-self-end pr-10 md:pr-14 pt-6">
