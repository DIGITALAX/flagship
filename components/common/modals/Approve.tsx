...
const Approve: FunctionComponent = (): JSX.Element => {
  ...
  return (
    <div className="relative w-full galaxy:w-96 h-fit bg-offBlack grid grid-flow-row auto-rows-[auto auto] col-start-1 p-4 gap-4">
      ...
      <button
        className={`w-24 h-12 row-start-4 relative text-white grid grid-flow-col auto-cols-[auto auto] place-self-center p-2 font-fira border-2 border-offWhite hover:bg-midBlue hover:cursor-sewingHS active:scale-95 ${
