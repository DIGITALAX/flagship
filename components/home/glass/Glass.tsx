    ...
    return (
        ...
        <div className="relative w-fit h-full col-start-1 place-self-center">
          <div className="relative w-full h-full gap-8 grid grid-flow-col auto-col-[auto auto]">
            ...
            <div className="relative  w-[14vw] h-[14vw] sm:w-14 sm:h-14 col-start-2 row-start-1 rounded-full border-2 border-offBlack place-self-center hover:rotate-180 active:rotate-180 cursor-sewingHS">
              <Image layout="fill" className="rounded-full" src="/images/dial2.png" />
            </div>
            <div className="relative  w-[14vw] h-[14vw] sm:w-14 sm:h-14 col-start-3 row-start-1 rounded-full border-2 border-offBlack place-self-center hover:rotate-90 active:rotate-90 cursor-sewingHS">
        ...
        <div className="relative w-fit h-full col-start-2 place-self-center">
          <div className="relative w-[24vw] h-[24vw] sm:w-24 sm:h-24 col-start-4 rounded-full border-2 border-offBlack place-self-center flex hover:rotate-180 active:rotate-180 cursor-sewingHS">
