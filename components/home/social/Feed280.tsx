...
const Feed280: FunctionComponent<FeedProps> = ({
  publicationsFeed,
  getMoreFeed,
  queryWindowSize,
        ...
        return (
          ...
          >
            <div className="relative grid grid-flow-row auto-rows-auto w-full h-full  rounded-xl drop-shadow-xl bg-white pb-4 pt-4 border-2 border-lightB">
              <div className="relative w-fit h-full row-start-1 pt-4 place-self-center sm:place-self-start half:place-self-center xl:place-self-start half:pr-2 half:pl-2 sm:pr-11 sm:pl-11 xl:pr-11 xl:pl-11 ">
                <div className="relative grid grid-flow-col auto-cols-auto w-fit h-full">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="cursor-sewingHS relative w-fit h-fit col-start-2 row-start-1 self-center pt-2 justify-center"
                  >
                    <div className="text-lensDark relative font-fira text-[5vw] xl:text-base whitespace-nowrap">
                  ...
                  <div className="relative w-fit h-fit pt-4 row-start-2 col-start-2 text-xs whitespace-nowrap grid grid-flow-col auto-cols-auto place-self-end">
                    ...
                    <div className="relative w-fit h-fit col-start-1 row-start-1 pt-0.5 pr-2">
              ...
              <div className="relative w-fit h-fit row-start-2 text-offBlack text-base font-gisL place-self-start p-5 pt-8 pb-6">
                {prompt}
              </div>
              <div className="relative w-fit h-full row-start-3 text-sm place-self-start text-offBlack p-5 pb-8 pt-0 font-gisL">
                {meta} {description}
              </div>
